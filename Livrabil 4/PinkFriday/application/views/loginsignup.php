...
<html lang="en">
  ...
  <body>
    ...
    <script>
        const sign_in_btn_html = document.getElementById("sign-in-submit");
        const sign_up_btn_html = document.getElementById("sign-up-submit");
        const sign_in_password_html = document.getElementById("sign-in-password");
        const sign_up_confirm_password_html = document.getElementById("sign-up-confirm-password");

        sign_in_password_html.addEventListener("keyup", function(event) {
          if (event.code === 'Enter') {
            event.preventDefault();
            sign_in_btn_html.click();
          }
        });
        
        sign_up_confirm_password_html.addEventListener("keyup", function(event) {
          if (event.code === 'Enter') {
            event.preventDefault();
            sign_up_btn_html.click();
          }
        });
