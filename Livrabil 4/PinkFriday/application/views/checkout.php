<html>
  ...
  <body>
    ...
    <div class="row">
          ...
          <form action="/action_page.php">
            <div class="row">
              <div class="colnormal">
                ...
                <input type="hidden" id="user_id" name="firstname" value = "<?php echo $id; ?>" required/>
                <input type="hidden" id="total" name="firstname" value = "<?php echo $total; ?>" required/>
                <label for="fname">Full Name*</label>
                <input type="text" id="fname" name="firstname" value = "<?php echo $fullname; ?>" required/>
            ...
            <input type="button" value="Continue the payment" class="btn" id = "checkout-btn"/>
          </form>
        </div>
      </div>
      ...
      <div class="colsmall">
        <div class="container">
          <h4>Cart</h4>
          <?php for ($i = 0; $i < $n; $i++) { ?>
          <p><a href="product/<?php echo $cart_data[$i][5]; ?>"><?php echo $cart_data[$i][0]; ?></a> <span class="price"><?php echo $cart_data[$i][2]; ?> RON x <?php echo $cart_data[$i][1]; ?></span></p>
          <?php } ?>
          <hr />
          <p>
            Total <span class="price" style="color: black"><b><?php echo $total; ?> RON </b></span>
          </p>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>JavaScript/checkout.js"></script>
